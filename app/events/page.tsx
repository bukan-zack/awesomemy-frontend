...
export default function Page() {
    ...
    const { data, mutate } = useSWR(`/public/events?page=${page}&limit=12&orderBy=${orderBy}`, 
        () => fetchEvents(page, 12, orderBy),
    );
    ...
    return (
        <main className="max-w-6xl mx-auto px-8 flex py-12 flex-col justify-center">
