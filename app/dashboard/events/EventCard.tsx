...
export function EventCard({
    ...
    return (
        <Link href={`/dashboard/events/${event.uuid}`}>
            <div className="h-full flex flex-col justify-between overflow-hidden transition duration-500 ease-in-out border border-white/15 hover:border-white/20 px-6 py-4 rounded-lg">
                <div>
